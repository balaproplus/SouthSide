...
<html class="no-js" lang="zxx">
  <head>
    ...
    <title>About  |  South Side Hip Hop Records</title>
    ...
    <link rel="stylesheet" href="assets/app/css/main2.css" />
  </head>
  ...
  <body>
    ...
    <div id="preloader">
      ...
      <img src="./assets/img/preloader/preloader gif.gif" alt="" width="360">
    </div>
    <!-- preloader end -->
    ...
    <div class="ms-all-content ms-all-content-space">
      <main>
        ...
        <section class="ms-about-area fix">
          <div
            class="ms-about-bg include__bg p-relative zindex-1 pt-120 pb-130"
            data-background="assets/img/about/about31.jpg"
          >
              ...
              <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10">
                  <div class="ms-about-content text-center">
                    <h2 class="ms-title2 white-text mb-30 bd-title-anim">
                      South Side Hip Hop Records India
                    </h2>
                    <p class="capitalize mb-15">
                      We exist not for trends — but for truth. Born in Tamil
                      Nadu, built by voices that demand to be heard.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <!-- work area start -->
        <section class="work__area pt-100 pb-20">
          <div class="container">
            <div class="row align-items-center bdFadeUp">
              <div class="col-xl-6">
                <div
                  class="ms-work3-thumb-wrap d-inline-block p-relative mb-60"
                >
                  <div class="ms-work3-inner">
                    <div class="ms-work3-thumb m-img p-relative fix ms-br-20">
                      ...
                      <img
                        src="assets/img/work/work-thumb-061.png"
                        alt="work image"
                      />
                    </div>
                    <div class="work__features-bottom ms-work3-features pb-0">
                      <div class="work__features-action">
                        <div class="work__features-btn ms-work3-feature-btn">
                          <a class="ms-fill-btn" href="contact.php"
                            >Get Started</a
                          >
                        </div>
                        <div class="features__btn-text">
                          <span>Join the <br />Movement!</span>
                        </div>
                      </div>
                      <div class="work__features-arrow">
                        <img
                          src="assets/img/work/arrow.png"
                          alt="image not found"
                        />
                      </div>
                    </div>
                ...
                <div class="work__content-wrapper p-relative mb-60">
                  <div class="section__title-wrapper mb-50">
                    <h2 class="section__title mb-40 bd-title-anim">
                      How We Build Real Sound
                    </h2>
                    <p class="mb-0">
                      No labels. No limits. Here's what defines South Side Hip
                      Hop:
                    </p>
                  </div>
                  <div class="work__features-inner">
                    <div class="work__features-item">
                      ...
                      <div class="work__features-content">
                        <h4>Lyrics from Life</h4>
                        <p>Born from scars and truth.</p>
                      </div>
                    </div>
                    <div class="work__features-item">
                      <div class="work__features-icon">
                      ...
                      <div class="work__features-content">
                        <h4>Raw Beats:</h4>
                        <p>Built to carry purpose and rebellion.</p>
                      </div>
                    </div>
                    <div class="work__features-item">
                      <div class="work__features-icon">
                        <span>
                          ...
                          >
                            <g clip-path="url(#clip0_36_396)">
                              ...
                              />
                              <path
                                d="M11.1395 22.5428L4.23499 26.5292"
                                stroke="white"
                                stroke-linecap="square"
                                stroke-linejoin="round"
                              />
                              ...
                              />
                              <path
                                d="M40.3529 34.7713V25.4452L31.4285 23.1008"
                                stroke="white"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                              />
                      ...
                      <div class="work__features-content">
                        <h4>Storytelling Bars:</h4>
                        <p>Voices that won't be silenced.</p>
                      </div>
                    </div>
                    <div class="work__features-item">
                      <div class="work__features-icon">
                      ...
                      <div class="work__features-content">
                        <h4>Home for the Unheard:</h4>
                        <p>More than a label. A legacy.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <!--  Why We Exist Area Start Here  -->
        <section class="ms-work-system-area pt-0 pb-10">
          <div class="container">
            <div class="ms-work-system-wrap pt-0">
              <div
                class="ms-work-system-img d-inline-block fix m-img ms-br-15 mb-60"
              >
                <img
                  src="assets/img/choose/choose-bg-1.png"
              ...
              <div class="row justify-content-center p-5">
                <div class="col-xl-10">
                  <div class="ms-work-system-inner text-center">
                    <h2 class="text-center">Born From a Need</h2>
                    <p class="text-center mt-30">
                      South Side Hip Hop Records India was created for real
                      artists — the ones who write bars on bus tickets, who
                      battle in backstreets, who refuse to be silenced.
                    </p>
                    <p class="text-center">
                      We're not here to follow the industry. We're here to
                      rebuild it — with authenticity, rebellion, and raw sound.
                    </p>
                    <div class="work__features-bottom d-inline-block mt-45">
                      <div class="work__features-action">
                        <div class="work__features-btn">
                          <a class="unfill__btn" href="contact.php"
                            >Get Started</a
                          >
                        </div>
                        <div class="features__btn-text">
                ...
                <div class="ms-team-item-wrap">
                  <div class="ms-team-item p-relative">
                    <div class="ms-team-img">
                      <a href="#"
                        ><img
                          src="assets/img/team/team-01-1.jpg"
                          alt="team image"
                      /></a>
                    ...
                    <h3 class="ms-team-title">
                      <a href="#">Essie L. Whitman</a>
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div class="ms-team-item-wrap">
                  <div class="ms-team-item p-relative">
                    <div class="ms-team-img">
                      <a href="#"
                        ><img
                          src="assets/img/team/team-02-1.jpg"
                          alt="team image"
                      /></a>
                      <div class="ms-team-social">
                        <a
                ...
                <div class="ms-team-item-wrap">
                  <div class="ms-team-item p-relative">
                    <div class="ms-team-img">
                      <a href="#"
                        ><img
                          src="assets/img/team/team-03-1.jpg"
                          alt="team image"
                      /></a>
                      <div class="ms-team-social">
                        <a
              ...
              <div class="swiper-container ms-partner-active">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img
                      src="assets/img/partner/partner-01.png"
                      alt="partner image"
                    />
                  </div>
                  <div class="swiper-slide">
                    <img
                      src="assets/img/partner/partner-02.png"
                      alt="partner image"
                    />
                  </div>
                  <div class="swiper-slide">
                    <img
                      src="assets/img/partner/partner-03.png"
                      alt="partner image"
                    />
                  </div>
                  <div class="swiper-slide">
                    <img
                      src="assets/img/partner/partner-04.png"
                      alt="partner image"
                    />
                  </div>
                  <div class="swiper-slide">
                    <img
                      src="assets/img/partner/partner-05.png"
                      alt="partner image"
                    />
                  </div>
                  <div class="swiper-slide">
